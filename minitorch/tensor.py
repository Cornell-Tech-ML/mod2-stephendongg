...
class Tensor:
    ...
    def __div__(self, other: TensorLike):
    ...
    def __lt__(self, other: TensorLike):
    ...
    def __eq__(self, other: TensorLike):
    ...
    def __gt__(self, other: TensorLike):
    ...
    def __radd__(self, other: TensorLike):
    ...
    def __rmul__(self, other: TensorLike):
    ...
    def view(self, *dim: int) -> Tensor:
        ...
        """
        dim_list = [float(x) for x in dim]

        # Pass the list of floats to the Tensor.make function
        dim_tensor = Tensor.make(dim_list, (len(dim_list),), backend=self.backend)
