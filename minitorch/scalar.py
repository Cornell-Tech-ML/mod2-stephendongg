...
class Scalar:
    ...
    def chain_rule(self, d_output: Any) -> Iterable[Tuple[Variable, Any]]:
        ...
        # Retrieve the function that was applied to create this Scalar
        fn = h.last_fn  # This is the function (e.g., Mul, Add) used during forward pass
        ctx = h.ctx  # Context saved during the forward pass

        local_grads = fn._backward(ctx, d_output)

        return zip(h.inputs, local_grads)
